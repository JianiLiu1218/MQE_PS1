...
In additions, to the instuctions given on the problem set, you may find the "GitHub instructions" course document helpful.
...
In the following chunk I generate simulated data consisting of two correlated variables. Notice the chunk setting is set to supress the warning messages that are generated when R loads a package. 
